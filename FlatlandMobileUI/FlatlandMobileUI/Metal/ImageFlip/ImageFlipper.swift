...
class ImageFlipper
{
    ...
    func FlipVertically(Source: UIImage) -> UIImage?
    {
        return DoFlip(Source: Source, FunctionName: "ImageFlipVertical")
    }
    
    func FlipHorizontally(Source: UIImage) -> UIImage?
    {
        return DoFlip(Source: Source, FunctionName: "ImageFlipHorizontal")
    }
    
    func FlipBoth(Source: UIImage) -> UIImage?
    {
        return DoFlip(Source: Source, FunctionName: "ImageFlipBoth")
    }
    
    func DoFlip(Source: UIImage, FunctionName: String) -> UIImage?
    {
